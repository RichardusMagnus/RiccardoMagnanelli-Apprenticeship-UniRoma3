...
public class StructureBuilder {
	...
	public StructureBuilder(List<Arc> allArcs, int[][] stationMatrix, int n, int m) {
		this.arcs = allArcs;
		this.n = n;
		this.m = m;
		this.stationMatrix = stationMatrix;
		
		this.arcManagerConstructor_auxiliary();
	}
	 ...
	 */
	public void arcManagerConstructor_auxiliary() {
	 ...
	 */
	public int[][] buildActivityMatrix() {
